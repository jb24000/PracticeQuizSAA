...
const questionBank = {
    ...
    cost: [
       ...
       // Additional questions to append to your existing questionBank
// This batch adds questions 26-50 for each domain (100 questions total)

// Add these to the security array (continuing from sec_025)
...
// Add these to the resilience array (continuing from res_025)
const additionalResilienceQuestions = [
    {
        id: 'res_026',
        domain: "Domain 2: Design Resilient Architectures",
        difficulty: "medium",
...
// Add these to the performance array (continuing from perf_025)
const additionalPerformanceQuestions = [
    {
        id: 'perf_026',
        domain: "Domain 3: Design High-Performing Architectures",
        difficulty: "medium",
...
// Add these to the cost array (continuing from cost_025)
    {
        id: 'cost_026',
        domain: "Domain 4: Design Cost-Optimized Architectures",
        difficulty: "medium",
    ...
    // Add these questions to your existing questionBank arrays
// Continue from question 051 in each domain

// Security Questions (051-100)
...
// Cost Optimization Questions (051-100)
const costAdditions = [
    {
        id: 'cost_051',
        domain: "Domain 4: Design Cost-Optimized Architectures",
